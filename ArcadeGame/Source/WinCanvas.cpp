...
****************************************************************************
*
*					new animated sprite class below
*
****************************************************************************
*/
void WinCanvas::DrawAnimTexture(int widthOfTexture, int heightOfTexture, int textureCol, int textureRow, Texture const & t, POINT2f pos)
{
	...
	HBITMAP hbmDefault = (HBITMAP)SelectObject(hdcMemory, wt->MaskHandle());
	BitBlt(m_hdcBuffer, (int)pos.x, (int)pos.y, widthOfTexture, heightOfTexture, hdcMemory, (textureCol*widthOfTexture), (textureRow*heightOfTexture), SRCAND);

	SelectObject(hdcMemory, wt->ImageHandle());
	BitBlt(m_hdcBuffer, (int)pos.x, (int)pos.y, widthOfTexture, heightOfTexture, hdcMemory, (textureCol*widthOfTexture), (textureRow*heightOfTexture), SRCPAINT);
